...
def Kill_Spaceflies():
    ...
    or other mods which accidentally add excess spaceflies through
    the "create ship" command, causing accumulating slowdown
    (eg. 85% SETA slowdown after 10 game days).
...
def Prevent_Accidental_Spacefly_Swarms(
    ...
    behind the spacefly swarm, with swarms accumulating over
    time and drastically slowing the game down.
    '''
