...
@File_Manager.Transform_Wrapper('types/TBackgrounds.txt')
def Set_Minimum_Fade_Distance(distance_in_km = 3):
    ...
    * distance_in_km : 
    ...
    for this_dict in File_Manager.Load_File('types/TBackgrounds.txt'):
...
def Remove_Stars_From_Foggy_Sectors(
    ...
    * fade_distance_requirement_km:
    ...
    tbackgrounds_dict_list = File_Manager.Load_File('types/TBackgrounds.txt')
    ...
    for image_name in images_allowing_star_removal_list:
        ...
        virtual_path = ('objects/environments/nebulae/'
                        '{}/nebula_{}_stars_01.bob').format(
