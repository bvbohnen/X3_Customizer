...
#  out.
@File_Manager.Transform_Wrapper('types/Globals.txt', 'types/TMissiles.txt')
def Adjust_Missile_Damage(
    ...
    * print_changes:
    ...
    for this_dict in File_Manager.Load_File('types/TMissiles.txt'):
        ...
        if print_changes:
            File_Manager.Write_Summary_Line('{:<30} : {:>10} -> {:>10}, x{}'.format(
                this_dict['name'],
                damage,
                new_damage_round,
...
@File_Manager.Transform_Wrapper('types/TMissiles.txt')
...
def Adjust_Missile_Speed(
    ...
    * print_changes:
    ...
    for this_dict in File_Manager.Load_File('types/TMissiles.txt'):
        ...
        #  and the scaling factor.
        if print_changes:
            File_Manager.Write_Summary_Line('{:<30} : {:>10.2f} -> {:>10.2f}, x{}'.format(
                this_dict['name'],
                speed,
                new_speed,
                # Give only two sig digits for the scaling factor.
