...
# Entry point.
def Run():
    # Import these here, to avoid them causing problems when not available
    #  if anywhere imports this module but doesn't use it.
    import numpy as np
    ...
    # It looks like numpy will need each variable as its own list, with all
    #  lists being packed together later
