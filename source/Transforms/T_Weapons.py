...
def _Initialize_Bullet_parent_to_child_dict():
    ...
    for index, this_dict in enumerate(Load_File('types/TBullets.txt')):
...
def _Initialize_Bullet_to_laser_dict():
    ...
    tbullets_dict_list = Load_File('types/TBullets.txt')

    # Loop over all lasers.
    for laser_dict in Load_File('types/TLaser.txt'):
...
def Adjust_Weapon_Fire_Rate(
    ...
    * skip_ammo_weapons:
    ...
    # Step through each laser.
    for this_dict in Load_File('types/TLaser.txt'):
...
def Adjust_Weapon_OOS_Damage(
    ...
    * scaling_factor:
    ...
    for this_dict in Load_File('types/TBullets.txt'):
        if scaling_factor != 1:
